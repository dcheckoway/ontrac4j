 ...
 *       &lt;sequence>
 *         &lt;element name="Shipment" type="{}ShipmentResponse" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfShipmentResponse {
    ...
    protected List<ShipmentResponse> shipment;
    ...
    public List<ShipmentResponse> getShipment() {
        if (shipment == null) {
            shipment = new ArrayList<ShipmentResponse>();
        }
